...
- (void)placeManager:(GMBLPlaceManager *)manager didBeginVisit:(GMBLVisit *)visit
{
    ...
    if ([visit.place.name isEqualToString:@"Reception"] || [visit.place.name isEqualToString:@"OnsiteReception"] || [visit.place.name isEqualToString:@"PHTNCHEBLK3"] || [visit.place.name isEqualToString:@"PhotonCheBlock3-Visit"] ) {
